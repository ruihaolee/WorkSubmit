;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        setToolbar : function() {
            ...
            for (var i = 0, len = icons.length; i < len; i++)
            {
                ...
                else if (name !== "image" && name !== "emoji" && name !== "preview" && name !== "fullscreen" && name !== "copyright")
                {
    ...
    editormd.loadCSS   = function(fileName, callback, into) {
       ...
       // console.log(fileName.substring(0,5));
        if(fileName.substring(0,7) === '//cdnjs'){
             css.href   = fileName + ".css";
        }
        else{
            css.href   = "/_vueFrame" + fileName + ".css";
        }
    ...
    editormd.loadScript = function(fileName, callback, into) {
        ...
        if(fileName.substring(0,7) === '//cdnjs'){
             ...
             script.src    = "/_vueFrame" + fileName + ".js";
        }
        if (editormd.isIE8) 
        {            
